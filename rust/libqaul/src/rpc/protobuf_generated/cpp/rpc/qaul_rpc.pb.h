...
constexpr Modules Modules_MAX = CHAT;
...
class QaulRpc final :
 ...
 public:
  ...
  ~QaulRpc() override;
  explicit constexpr QaulRpc(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline ::qaul::rpc::Modules QaulRpc::_internal_module() const {
  return static_cast< ::qaul::rpc::Modules >(module_);
}
